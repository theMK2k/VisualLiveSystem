...
/*
	ST The Drive Home v1.0
	ported from ShaderToy by MK2k https://mk2k.net
	ShaderToy URL:   https://www.shadertoy.com/view/MdfBRX (2018-03-02)
	Original Author: https://www.shadertoy.com/user/BigWIngs
...
vec3 StreetLights(float i, float t) {
    ...
    return m*streetLightCol*(CC[0] + CC[1]*bass)*2.0;
}
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    //vec2 uv = fragCoord.xy / iResolution.xy; // 0 <> 1
		vec2 uv = fragCoord.xy / resolution.xy*2.0; // 0 <> 1
    ...
    bumps = bumps*bumps*bumps*CAM_SHAKE;	// +CC[1]*bass*.1
