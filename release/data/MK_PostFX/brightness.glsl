...
/*
	...
	Modified postprocess for use with single scenes using their own bass fx offset and bass fx (CC[0] and CC[1])
*/
...
void main()
{
	...
	col *= (0.0 + CC[0]*2.5 + CC[1]*bass*2.5);	// brightness based on indiviual setting in CC[0] (brightness) and bass amplified by CC[1] (bass strobe)
